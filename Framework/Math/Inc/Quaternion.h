...
namespace GGEngine::GGMath
{
    ...
    struct Quaternion
    {
        ...
        //Rotation
        static Quaternion RotationAxis(const Vector3& axis, float rad) noexcept;
        static Quaternion RotationEuler(const Vector3& eulerAngles) noexcept;
        static Quaternion RotationMatrix(const Matrix4& mat) noexcept;
        static Quaternion RotationLook(const Vector3& direction, const Vector3& up) noexcept;
        static Quaternion RotationFromTo(const Vector3& from, const Vector3& to) noexcept;
    };
}