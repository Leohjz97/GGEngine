...
using namespace GGEngine::GGMath::Constants;
...
namespace
{
    ...
    {
        mVertexShader.Initialize<VertexPC>(L"../../Assets/Shaders/SimpeDraw.fx");
        mPiexlShader.Initialize(L"../../Assets/Shaders/SimpeDraw.fx");
    ...
    void SimpleDrawImpl::Render(const Camera& cam) 
    {
        ...
        auto matProj = cam.GetProjectionMatrix();
...
void SimpleDraw::StaticInitalize(uint32_t maxVertexCount)
{
