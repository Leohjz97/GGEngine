...
namespace GGEngine::Graphic
{
    ...
    public:
        ...
        void Initialize(const vector<VertexType>& verticies)
        {
        ...
        void Initialize(const void* verticies, uint32_t vertexSize, uint32_t vertexCount, const uint32_t* indics, uint32_t indexCount);
        void Terminate();
    ...
    private:
        ...
        void CreateIndexBuffer(const uint32_t* indics, uint32_t indexCount);
